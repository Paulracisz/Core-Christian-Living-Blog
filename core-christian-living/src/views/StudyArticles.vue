<template>
  <div id="study-flexbox">
    ...
    <h1 class="">Topics</h1>
    <div id="buttons-flex">
    <RouterLink id="nav-text" to="/"><button>All</button></RouterLink>
    <RouterLink id="nav-text" to="/prayer-articles"><button>Prayers</button></RouterLink>
    <RouterLink id="nav-text" to="/study-articles"><button  id="selected-button">Bible Studies</button></RouterLink>
